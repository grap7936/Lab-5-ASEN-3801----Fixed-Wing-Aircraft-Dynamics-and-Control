...
%
% Modified by Lucas Nussbaumer to be a function for calling inside any
% script in order to keep code concise as well as create an easy way to
% pass the different states.
