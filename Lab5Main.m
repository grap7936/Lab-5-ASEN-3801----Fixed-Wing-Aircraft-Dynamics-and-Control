...
% initial condition vector
% Units: x0_2 = [m; m; m; deg; rad; deg; m/s; m/s; m/s; deg/s; deg/s; deg/s]
initial_conditions4 = [0, 0, -1800, 0, 0.02780, 0, 20.99, 0, 0.5837, 0, 0, 0]';

% Control surface input vector
u0_4 = [0.1079; 0; 0; 0.3182];
w0_4 = [0; 0; 0];

[t_4, states_4] = ode45(@(time, aircraft_state) AircraftEOMDoublet(time, aircraft_state, u0_4, doublet_size, doublet_time, w0_4, aircraft_parameters), tspan, initial_conditions4);
states_4 = states_4';

delta_e = OutputDelta_e(t_4, u0_4, doublet_time, doublet_size);

control4_2 = u0_4(2)*ones(1,length(t_4));
control4_3 = u0_4(3)*ones(1,length(t_4));
control4_4 = u0_4(4)*ones(1,length(t_4));

control_input_array4 = [delta_e; control4_2; control4_3; control4_4];
